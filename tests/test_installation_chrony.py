...
def run_default_config(existing_config="", management_ip6="2001:db8::10"):
...
"""
    result = subprocess.run(
        ...
        text=True,
        capture_output=True,
        env={"EXISTING_CONFIG": existing_config, "MOCK_MANAGEMENT_IP6": management_ip6},
    )
...
cat "$STATE_FILE"
"""
    state_file = Path(__file__).parent / ".installation-chrony-state"
