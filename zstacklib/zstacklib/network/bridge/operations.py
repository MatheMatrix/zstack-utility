...
def is_bridge_slave(interface: str) -> bool:
    """Check if the interface is a bridge port."""
...
def is_interface_on_bridge(bridge: str, interface: str) -> bool:
    """Check if an interface is attached to a bridge."""
...
def list_bridges() -> list[str]:
    """List all bridge devices on the system."""
    bridges = []
