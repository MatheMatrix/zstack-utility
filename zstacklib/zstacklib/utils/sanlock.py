...
SANLK_LEASE_CORRUPTED = (SANLK_LEADER_MAGIC, SANLK_LEADER_VERSION, SANLK_LEADER_LOCKSPACE, SANLK_LEADER_RESOURCE,
                         SANLK_LEADER_NUMHOSTS, SANLK_LEADER_CHECKSUM, -221)
