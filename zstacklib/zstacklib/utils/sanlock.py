...
def get_sector_size(vg_uuid):
    ...
    if r == 0:
        ...
        logger.debug("retrieve sanlock backup metadata from shared storage %s at 65MB.")
    ...
    if r == 0:
        logger.debug("retrieve sanlock backup metadata from shared storage %s at 520MB.")
