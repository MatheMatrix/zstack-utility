...
class Vm(object):
    ...
    def block_stream_disk(self, task_spec, volume, base=None):
        ...
        base = base if base is None else VolumeTO.get_volume_actual_installpath(base)
...
{3}""".format(cmd.vmUuid, cmd.volumeUuid, '\n'.join(sorted_volume_chain), '\n'.join(back_file_chain)))
    ...
    def block_pull(self, req):
        ...
        volumeInstallPath = VolumeTO.get_volume_actual_installpath(cmd.volume.installPath)
