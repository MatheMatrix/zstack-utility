...
class ZbsVhostRpc(object):
    ...
    # bdev path is the zbs file path in <logical_pool>/<volume>_<user>_ form,
    # same convention as the cbd qemu-io path used by zbs_storage_plugin.
    ...
    # guest-visible block size comes from the bdev; 512e (logical 512 over a 4096
    # backend) must be done inside bdev_zbs, not advertised here.
