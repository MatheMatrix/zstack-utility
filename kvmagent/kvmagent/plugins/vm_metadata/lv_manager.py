...
Implements vm-metadata-04e-sblk-ops.md (§2 LV capacity / §3 LV lifecycle).
...
def initialize_metadata_lv(lv_path, lv_size):
    ...
    try:
        ...
        # Step 2.5: Zero-fill Slot B region to avoid residual data
        #   interfering with recovery (§3.1)
