...
class SharedMountPointPrimaryStoragePlugin(kvmagent.KvmAgent):
    ...
    GET_BACKING_FILE_PATH = "/sharedmountpointprimarystorage/volume/backingfile"
    ...
    def offline_commit_snapshots(self, req):
        ...
        for children in cmd.srcChildrenInstallPathInDb:
            if linux.qcow2_get_backing_file(children) != cmd.dstPath:
                linux.qcow2_rebase_no_check(cmd.dstPath, children)
