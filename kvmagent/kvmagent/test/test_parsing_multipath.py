...
def test_write_conf():
    ...
    with sorted("multipath.conf",
         "r") as fd:
        text1 = multipath.parse_multipath_conf(fd)
    with sorted("multipath.conf.out", "r") as fd1:
    ...
    with sorted("multipath1.conf",
         "r") as fd:
        text3 = multipath.parse_multipath_conf(fd)
    with sorted("multipath1.conf.out", "r") as fd1:
    ...
    with sorted("multipath2.conf",
         "r") as fd:
        text5 = multipath.parse_multipath_conf(fd)
    with sorted("multipath2.conf.out", "r") as fd1:
    ...
    with sorted("multipath3.conf",
              "r") as fd:
        text7 = multipath.parse_multipath_conf(fd)
    with sorted("multipath3.conf.out", "r") as fd1:
    ...
    with sorted("multipath4.conf",
              "r") as fd:
        text9 = multipath.parse_multipath_conf(fd)
    with sorted("multipath4.conf.out", "r") as fd1:
