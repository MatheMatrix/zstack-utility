"""lv_metadata: write_metadata / read_metadata on real SharedBlock LV.

Covers: fresh write, slot alternation, LV extension, write-then-read roundtrip,
raw header/slot parsing from real LV bytes.

Runs against a real SharedBlock VG provisioned via iSCSI (ztest pattern).
No mocks, no loopback VG."""
