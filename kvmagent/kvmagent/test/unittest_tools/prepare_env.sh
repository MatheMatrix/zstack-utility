...
prepare_mn_mock() {
    ...
    # pip install -r requirements/requirements1.txt -i file:///root/.zguest/zstack-utility/kvmagent/kvmagent/test/unittest_tools/unittest_pypi_source//pypi/simple
    # pip install -r requirements/requirements2.txt -i file:///root/.zguest/zstack-utility/kvmagent/kvmagent/test/unittest_tools/unittest_pypi_source//pypi/simple
