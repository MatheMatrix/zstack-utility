...
def install_kvm_pkg():
    def rpm_based_install():
        ...
        distro_mapping = {
            ...
            'kylin': 'vconfig open-iscsi python2-pyudev collectd-disk OpenIPMI libselinux-devel nettle tuned qemu-kvm libicu edac-utils lldpd freeipmi tcpdump key-manager',
