...
def install_kvm_pkg():
    def rpm_based_install():
        ...
        releasever_mapping = {
            ...
            'oe2403sp1': 'vconfig open-iscsi qemu python2-pyudev collectd-disk tcpdump',
...
def install_python_pkg():
    ...
    environment = get_install_python_pkg_environment()
    ...
    pip_install_arg.environment = environment
...
def get_install_python_pkg_environment():
    environment = {}
    if releasever == "oe2403sp1" and host_info.host_arch == "loongarch64":
        environment["CFLAGS"] = "-O2 -fno-strict-aliasing -g -DNDEBUG -fwrapv -Wall -Wstrict-prototypes -fPIC"
    return environment
